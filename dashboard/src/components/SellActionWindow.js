...
const SellActionWindow = ({ uid }) => {
  ...
  return (
    <div className="container" id="sell-window" ref={dragContainer}>
      <div className="sellHeader" onMouseDown={mouseDown}>
        <h3>Sell {uid} <span>NSE</span> X {stockQuantity} Qty</h3>
