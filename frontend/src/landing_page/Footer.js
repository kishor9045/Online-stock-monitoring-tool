    ...
    return (
        <footer className="border-top mt-5" style={{backgroundColor: "#FBFBFB"}}>
            <div className="container mt-5">
                <div className="row">
                    <div className="col">
                        <img src="media/images/logoNew.png" alt="footer Logo" style={{width:"60%"}}/>
                        <p className="mt-3" style={{color:"#666666"}}>&copy; 2010 - 2025, Tradexa Broking Ltd. All rights reserved.</p>
                    </div>
                    <div className="col">
                    ...
                    <div className="col">
                        ...
                        <ul style={{lineHeight:"3em", padding:"0px"}}>
                            ...
                            <li style={{listStyleType:"none"}}><a href="/" style={anchor}>Tradexa Cares (CSR)</a></li>
                            <li style={{listStyleType:"none"}}><a href="/" style={anchor}>Tradexa.tech</a></li>
                ...
                <div className="mt-4">
                    <p style={para}>Tradexa Broking Ltd.: Member of NSE, BSE​ &​ MCX – SEBI Registration no.: INZ000031633 CDSL/NSDL: Depository services through Tradexa Broking Ltd. – SEBI Registration no.: IN-DP-431-2019 Commodity Trading through Tradexa Commodities Pvt. Ltd. MCX: 46025; SEBI Registration no.: INZ000038238 Registered Address: Tradexa Broking Ltd., #153/154, 4th Cross, Dollars Colony, Opp. Clarence Public School, J.P Nagar 4th Phase, Bengaluru - 560078, Karnataka, India. For any complaints pertaining to securities broking please write to complaints@tradexa.com, for DP related to dp@tradexa.com. Please ensure you carefully read the Risk Disclosure Document as prescribed by SEBI | ICF</p>
