    ...
    return(
        < >
            <div style={{marginBottom:"100px"}}>
                ...
                <TicketDropdown iconClass="fa-regular fa-circle-user" title="Your Tradexa Account" collapseId="multiCollapse2" li1="Your Profile" li2="Account modification" li3="Client Master Report (CMR) and Depository Participant (DP)" li4="Nomination" li5="Transfer and conversion of securities"/>
